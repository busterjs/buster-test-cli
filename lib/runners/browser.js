...
var testRun = {
    ...
    testRunHook: function (runner, session) {
        try {
    ...
    createRemoteRunner: function (session, slaves) {
        return remoteRunner.create(session, slaves, {
    ...
    runTests: function (session, callback) {
        ...
        session.onLoad(function (slaves) {
            ...
            var runner = this.createRemoteRunner(session, slaves);
            var hookError = this.testRunHook(runner, session, callback);
            if (hookError) {
