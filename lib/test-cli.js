...
function prepareOptions(args) {
    return B.extend({
        ...
        captureConsole: !args.releaseConsole.isSet,
        staticResourcePath: args.staticResourcePath.isSet,
        logPassedMessages: args.logAll.isSet
    }, colorOpt[args.color.value]);
}
...
module.exports = {
    ...
    run: function (cliArgs, callback) {
        ...
        this.cli.parseArgs(cliArgs, function (err) {
            ...
            this.cli.loadConfig(B.bind(this, function (err, groups) {
                ...
                this.runConfigGroups(groups, prepareOptions(args), callback);
            }));
        }.bind(this));
    },
    ...
    runConfig: function (group, options, callback) {
        ...
        this.loadRunner(group.environment, function (err, runner) {
            ...
            runner.run(group, options, callback);
        }.bind(this));
    },
    ...
    runners: {
        ...
        get browser() { return require("./runners/browser-runner"); }
    }
};
