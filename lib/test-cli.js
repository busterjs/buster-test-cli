...
function runWithAnalyzer(runner, config, options, logger, cb) {
    ...
    runner.run(config, options, callback);
...
function addExtensions(extensions, config) {
    ...
    extensions.forEach(function (ext) { config.extensions.push(ext); });
}
...
module.exports = {
    ...
    runConfigGroups: function (configGroups, options, callback) {
        ...
        var nextGroup = function (err, results) {
            ...
            if (!config) { return this.exit(exitCode(runs), callback); }
    ...
    runConfig: function (config, options, callback) {
        addExtensions(this.extensions, config);
        ...
        this.loadRunner(config.environment, function (err, runner) {
            ...
            runWithAnalyzer(runner, config, options, this.logger, callback);
        }.bind(this));
    },
