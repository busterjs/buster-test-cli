...
var stdioLogger = require("buster-cli").stdioLogger;
var term = require("buster-terminal");
var argValidators = bArgs.validators;
...
module.exports = {
    ...
    opt: function opt(short, long, help, options) {
        this.args = this.args || Object.create(bArgs);
    ...
    addOptions: function () {
        ...
        this._help.acceptsValueAbsence = true;
