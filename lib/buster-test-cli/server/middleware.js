...
module.exports = {
    create: function () {
        ...
        server.buster = Object.create(buster.server);

        server.buster.captureMiddleware.oncapture = function (req, res, client) {
            res.writeHead(302, { "Location": client.url });
            res.end();
        };

        server.buster.captureMiddleware.captureUrl = "/capture";
    ...
    get clients() {
        return this.buster.captureMiddleware.capturedClients.map(function (c) {
