...
module.exports = buster.extend(buster.create(require("buster-cli")), {
    ...
    onRun: function () {
        var options = buster.extend({
            ...
            captureConsole: this.captureConsole.isSet,
    ...
    loadOptions: function () {
        ...
        this.captureConsole = this.opt(
            "-a",
            "--capture-console",
            "Capture log messages from console.log and friends. Replaces the " +
                "global console object with the buster.console object");
        ...
        this.staticResourcePath = this.opt(
            ...
            "Serve files over a static URL on the server. Reusing paths "+
                ...
                "but increases the risk of stale resources due to over-eaher " +
                "browser caching");
