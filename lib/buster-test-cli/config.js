...
buster.configuration = require("buster-configuration").config;
buster.client = require("buster-client");

var version = require("../buster-test-cli").VERSION;
var confAddGroup = buster.configuration.addGroup;
...
module.exports = buster.extend(buster.create(buster.configuration), {
    addGroup: function addGroup() {
        var group = confAddGroup.apply(this, arguments);

        if (group.sessionConfig) {
            extendConfiguration(group);
        }
...
function extendConfiguration(config) {
